@echo off
title Smart Board - Tableau Collaboratif
color 0A

:: ================================================
:: SMART BOARD UNIVERSAL LAUNCHER TEMPLATE
:: Application: Tableau Collaboratif
...
set "APP_PATH=%BASE_PATH%\SMART_BOARD_Apps\whiteboards\collaborative_board"
...
echo.
echo ================================================================
echo    SMART BOARD - Tableau Collaboratif
echo ================================================================
echo.
...
echo [INFO] Démarrage de Tableau Collaboratif...
...
"%PYTHON_ENV%\Scripts\python.exe" "main.py" 2>"%LOGS_PATH%\collaborative_board_error.log"

:: Gestion des codes de sortie
if %errorLevel% neq 0 (
    echo.
    echo [ERREUR] L'application s'est terminée avec une erreur (Code: %errorLevel%)
    echo [INFO] Vérifiez le fichier de log: %LOGS_PATH%\collaborative_board_error.log
    pause
    exit /b %errorLevel%
)
