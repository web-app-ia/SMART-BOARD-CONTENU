@echo off
title Smart Board - Tableau de Dessin
color 0A

:: ================================================
:: SMART BOARD UNIVERSAL LAUNCHER TEMPLATE
:: Application: Tableau de Dessin
...
set "APP_PATH=%BASE_PATH%\SMART_BOARD_Apps\whiteboards\drawing_board"
...
echo.
echo ================================================================
echo    SMART BOARD - Tableau de Dessin
echo ================================================================
echo.
...
echo [INFO] Démarrage de Tableau de Dessin...
...
"%PYTHON_ENV%\Scripts\python.exe" "main.py" 2>"%LOGS_PATH%\drawing_board_error.log"

:: Gestion des codes de sortie
if %errorLevel% neq 0 (
    echo.
    echo [ERREUR] L'application s'est terminée avec une erreur (Code: %errorLevel%)
    echo [INFO] Vérifiez le fichier de log: %LOGS_PATH%\drawing_board_error.log
    pause
    exit /b %errorLevel%
)
