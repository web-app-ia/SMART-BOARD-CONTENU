@echo off
title Smart Board - Simulateur Scientifique
color 0A

:: ================================================
:: SMART BOARD UNIVERSAL LAUNCHER TEMPLATE
:: Application: Simulateur Scientifique
:: Category: resources
:: Version: 1.0.0
:: ================================================
...
set "APP_PATH=%BASE_PATH%\SMART_BOARD_Apps\resources\science_sim"
...
echo.
echo ================================================================
echo    SMART BOARD - Simulateur Scientifique
echo ================================================================
echo.
...
echo [INFO] Démarrage de Simulateur Scientifique...
...
"%PYTHON_ENV%\Scripts\python.exe" "main.py" 2>"%LOGS_PATH%\science_sim_error.log"

:: Gestion des codes de sortie
if %errorLevel% neq 0 (
    echo.
    echo [ERREUR] L'application s'est terminée avec une erreur (Code: %errorLevel%)
    echo [INFO] Vérifiez le fichier de log: %LOGS_PATH%\science_sim_error.log
    pause
    exit /b %errorLevel%
)
