@echo off
title Smart Board - Outils Mathématiques
color 0A

:: ================================================
:: SMART BOARD UNIVERSAL LAUNCHER TEMPLATE
:: Application: Outils Mathématiques
:: Category: resources
:: Version: 1.0.0
:: ================================================
...
set "APP_PATH=%BASE_PATH%\SMART_BOARD_Apps\resources\math_tools"
...
echo.
echo ================================================================
echo    SMART BOARD - Outils Mathématiques
echo ================================================================
echo.
...
echo [INFO] Démarrage de Outils Mathématiques...
...
"%PYTHON_ENV%\Scripts\python.exe" "main.py" 2>"%LOGS_PATH%\math_tools_error.log"

:: Gestion des codes de sortie
if %errorLevel% neq 0 (
    echo.
    echo [ERREUR] L'application s'est terminée avec une erreur (Code: %errorLevel%)
    echo [INFO] Vérifiez le fichier de log: %LOGS_PATH%\math_tools_error.log
    pause
    exit /b %errorLevel%
)
