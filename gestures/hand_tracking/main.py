...
# -*- coding: utf-8 -*-
'''
Smart Board Application: Suivi des Mains
...
def main():
    '''
    Application principale pour Suivi des Mains
    '''
    print("=" * 60)
    print(f"    SMART BOARD - Suivi des Mains")
    print("=" * 60)
    print()
    ...
    while True:
        ...
        cv2.putText(frame, "Suivi des Mains", (10, 30), 
