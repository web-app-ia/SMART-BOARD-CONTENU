...
# -*- coding: utf-8 -*-
'''
Smart Board Application: Compteur de Doigts
Category: Gestuelle des Mains
...
def main():
    '''
    Application principale pour Compteur de Doigts
    '''
    print("=" * 60)
    print(f"    SMART BOARD - Compteur de Doigts")
    print("=" * 60)
    print()
    ...
    while True:
        ...
        cv2.putText(frame, "Compteur de Doigts", (10, 30), 
                   cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
        cv2.putText(frame, "Appuyez sur 'q' pour quitter", (10, 70), 
                   cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
        
        # Afficher le frame
        cv2.imshow('Compteur de Doigts', frame)
