@echo off
title Smart Board - Compteur de Doigts
color 0A

:: ================================================
:: SMART BOARD UNIVERSAL LAUNCHER TEMPLATE
:: Application: Compteur de Doigts
:: Category: gestures
:: Version: 1.0.0
:: ================================================
...
set "APP_PATH=%BASE_PATH%\SMART_BOARD_Apps\gestures\finger_counter"
...
echo.
echo ================================================================
echo    SMART BOARD - Compteur de Doigts
echo ================================================================
echo.
...
echo [INFO] Démarrage de Compteur de Doigts...
...
"%PYTHON_ENV%\Scripts\python.exe" "main.py" 2>"%LOGS_PATH%\finger_counter_error.log"

:: Gestion des codes de sortie
if %errorLevel% neq 0 (
    echo.
    echo [ERREUR] L'application s'est terminée avec une erreur (Code: %errorLevel%)
    echo [INFO] Vérifiez le fichier de log: %LOGS_PATH%\finger_counter_error.log
    pause
    exit /b %errorLevel%
)
