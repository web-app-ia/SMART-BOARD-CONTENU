...
# -*- coding: utf-8 -*-
'''
Smart Board Application: Contrôle Gestuel
...
def main():
    '''
    Application principale pour Contrôle Gestuel
    '''
    print("=" * 60)
    print(f"    SMART BOARD - Contrôle Gestuel")
    print("=" * 60)
    print()
    ...
    while True:
        ...
        cv2.putText(frame, "Contrôle Gestuel", (10, 30), 
